...
interface StatsBandProps {
  ...
  badge?: string;
  stats: Stat[];
  /** Faint background photo for the dark band. */
  image?: string;
}

/**
 * Dark, textured stats strip with square yellow-bordered stat columns.
 * Used to break up thin pages and surface proof points.
 */
export default function StatsBand({ heading, badge, stats, image }: StatsBandProps) {
  return (
    <section className="relative py-12 sm:py-14 overflow-hidden">
      <DarkSectionBackdrop image={image} imageOpacity={8} />
