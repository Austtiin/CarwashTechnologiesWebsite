      ...
      <div className="container mx-auto px-4 text-center relative z-10 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col gap-4 justify-center items-center mt-8 sm:flex-row sm:gap-6">
            <div className="bg-[#f0da11] text-gray-900 px-8 py-4 rounded-none font-bold shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div className="border-2 border-white/30 text-white px-8 py-4 rounded-none font-bold hover:bg-white/10 transition-all duration-300">
              <span className="flex items-center">
