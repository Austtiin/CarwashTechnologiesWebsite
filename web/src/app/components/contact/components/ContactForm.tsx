...
export default function ContactForm({ selectedOption, onReset }: ContactFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-6xl mx-auto bg-white border border-gray-200 p-6 sm:p-8 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <div className="group">
            ...
            <textarea
              ...
              onChange={handleInputChange}
              className="w-full px-4 py-2.5 border-2 border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-[#f0da11] focus:border-[#f0da11] transition-all duration-200 resize-vertical min-h-[100px] placeholder-gray-400"
      ...
      {/* Disclaimer */}
      <div className="mt-6 px-4 py-4 bg-gray-50 border-l-4 border-[#f0da11]">
      ...
      <div className="mt-8 text-center">
        <button
          ...
          className="group bg-[#f0da11] text-gray-900 px-10 py-4 font-bold text-base hover:bg-[#d0b211] transition-all duration-300 shadow-xl transform hover:-translate-y-1 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none relative overflow-hidden uppercase tracking-wide cursor-pointer"
        >
          {isSubmitting ? (
