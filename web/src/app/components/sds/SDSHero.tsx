    ...
    <section className="relative bg-gradient-to-br from-black via-gray-900 to-black text-white py-20 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 text-center z-10">
        <div className="max-w-5xl mx-auto">
          <div className="inline-flex items-center bg-black/50 border-2 border-[#f0da11] px-8 py-3 mb-8">
            ...
            <span className="text-sm font-semibold text-[#f0da11] tracking-wide uppercase">SAFETY COMPLIANCE CENTER</span>
          </div>
