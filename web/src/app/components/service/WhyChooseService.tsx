...
export default function WhyChooseService({ stats }: WhyChooseServiceProps) {
  const benefits = [
    ...
    },
    {
      ...
      description: 'Emergency service support is available to help minimize downtime.',
          ...
          <div className="bg-slate-50 p-8 border border-gray-200 border-l-4 border-l-[#f0da11] relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-[#f0da11] flex items-center justify-center mr-3">
                  <svg className="w-6 h-6 text-slate-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold text-gray-900">Service Highlights</h3>
              </div>
