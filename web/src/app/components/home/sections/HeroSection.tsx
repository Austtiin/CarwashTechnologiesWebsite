  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-yellow-200/20 via-white/80 to-yellow-200/50 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-gray-900/25 via-transparent to-white/15" />
        <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/10 via-yellow-400/15 to-yellow-300/10" />
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          <div className="absolute top-10 left-4 w-20 h-20 sm:top-20 sm:left-20 sm:w-40 sm:h-40">
            <div className="w-full h-full border-2 border-yellow-400/60 transform rotate-30 animate-pulse bg-yellow-400/10 backdrop-blur-sm"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-center lg:text-left space-y-8 bg-white/15 rounded-2xl p-10">
              ...
              <div className="space-y-4">
                <h1 className="font-friz text-5xl lg:text-7xl font-bold !text-black leading-tight">
                  CARWASH
              ...
              <BlurText
                ...
                delay={0.0}
                duration={0.1}
                className="text-center lg:text-left text-xl md:text-xl text-black"
              />
