      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          <div className="inline-block mb-6 px-6 py-2 border-2 border-[#f0da11] bg-gray-800/50">
            <span className="text-[#f0da11] font-bold uppercase tracking-wider text-sm">Professional Wash Chemicals</span>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-12">
            <div className="border-2 border-gray-700 bg-gray-800/50 p-6 text-center">
              <div className="text-3xl font-bold text-[#f0da11] mb-2">100%</div>
