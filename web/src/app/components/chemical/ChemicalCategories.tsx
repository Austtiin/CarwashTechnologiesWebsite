...
export default function ChemicalCategories({ categories }: ChemicalCategoriesProps) {
  return (
    <>
      {/* Bold Divider */}
            ...
            return (
              <div key={category.id} className="bg-white border-2 border-gray-300 hover:border-gray-400 transition-colors duration-200">
                <div className="border-b-2 border-gray-300 bg-gray-50 p-3 flex items-center justify-center">
                  ...
                  <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide">{category.title}</h3>
                </div>
                <div className="p-4">
                  <p className="text-gray-700 mb-3 text-xs leading-relaxed">{category.description}</p>
