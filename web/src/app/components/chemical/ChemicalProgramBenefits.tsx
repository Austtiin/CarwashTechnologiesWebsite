    ...
    <>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="bg-slate-50 p-8 border border-gray-200 border-l-4 border-l-[#f0da11] relative overflow-hidden">
            <div className="relative z-10">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-[#f0da11] text-black flex items-center justify-center mr-3">
              ...
              <ul className="space-y-4">
                {benefits.map((benefit, index) => (
                  <li key={index} className="flex items-center">
                    <svg className="w-5 h-5 text-[#d0b211] mr-3 shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="mt-6 pt-4 border-t border-gray-200">
                <div className="flex items-center text-sm text-gray-600">
                  <svg className="w-4 h-4 text-[#d0b211] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <div className="space-y-6 mt-8">
              {whyChooseReasons.map((reason, index) => (
                <div key={index} className="flex items-start">
                  <div className={`w-12 h-12 bg-linear-to-br ${reason.color} flex items-center justify-center mr-4 shrink-0`}>
            ...
            <div className="mt-8 p-6 bg-slate-50 border border-gray-200 border-l-4 border-l-[#f0da11]">
