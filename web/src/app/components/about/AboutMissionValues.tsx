      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {/* Mission */}
            <div className="bg-white p-8 shadow-lg border border-gray-200 border-t-4 border-t-[#f0da11] text-center">
          ...
          <div className="mt-16 text-center py-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="w-20 h-20 bg-slate-900 flex items-center justify-center mx-auto mb-4">
